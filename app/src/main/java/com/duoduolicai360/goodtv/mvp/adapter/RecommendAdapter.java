...
import com.duoduolicai360.goodtv.mvp.activity.ContentActivity;
import com.duoduolicai360.goodtv.utils.DensityUtil;
...
public class RecommendAdapter extends RecyclerArrayAdapter<Recommend.RoomBean> {
    ...
    public class RecommendViewHolder extends BaseViewHolder<Recommend.RoomBean>{
        ...
        private void startRoom(Context context, Recommend.RoomBean.ListBean listBean) {
            Intent intent = new Intent(context, ContentActivity.class);
